...
<head>
	...
	<link href="<?php echo ROOT_PATH; ?>cisticket/unit.css" rel="stylesheet">
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>cisticket/cisticket.js"></script>
	<!--[if lte IE 7]>
        ...
        <div id="ubc7-unit" class="row-fluid expand">
            <div class="span12">
                ...
                <div id="ubc7-unit-name">
                    <a href="<?php echo ROOT_PATH; ?>"><span id="ubc7-unit-faculty">Faculty of Applied Science</span><span id="ubc7-unit-identifier">Centre for Instructional Support: Service Requests</span></a>
                </div>
            </div>
        </div>
