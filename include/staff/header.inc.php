...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>cisticket/unit.css" media="all">
    ...
    <div id="header">
        <p id="info" class="pull-right no-pjax"><?php echo sprintf(__('Welcome, %s.'), '<strong>'.$thisstaff->getFirstName().'</strong>'); ?>
           <?php
            ...
            <?php } ?>
            | <a href="http://cisticket.ca/webmail/">support@cisticket.ca webmail</a>
            | <a href="http://cisticket.ca/cpanel/">Cpanel</a>
